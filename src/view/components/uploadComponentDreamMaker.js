    ...
    render() {
        ...
        return (
            ...
            <div ref={this.wrapperRef} style={{
                ...
                <div style={{ height: "30px", cursor: "pointer", width: "120px", position: "absolute", bottom: "0" }} onClick={this.handleSubmission}>{state.popupSwitch.includes("update")?"Save": "Create Recipe"}</div>
