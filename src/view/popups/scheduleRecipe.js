 ...
 */
export default class ScheduleRecipe extends Component {
  constructor(props) {
    super(props);
...
class MainContent extends Component{
  ...
  render(){
    ...
    <div>
       ...
       <MapComponent  name="recipe" app={app} cells={[{custom: PrepareUpdateCheckBox, props:{app:app}},'name']}  />
       {(state.checkComplete && state.opps.getUpdater("update").length>0) &&(
        ...
        <div onClick={()=>{
          ...
          for(const key in list){
            let obj={...list[key].getJson(), _id: undefined, type:"scheduledRecipe", day:state.day}
            array.push(obj)
          }
          state.opps.cleanJsonPrepareRun({addscheduledRecipe: array});
